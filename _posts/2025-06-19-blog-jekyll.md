...
tags:
  ...
  - SSG
  - Github Pages
excerpt:  "어느 날 삘 받은 백수가 Github pages와 Jekyll을 이용해서 개인 블로그와 웹사이트를 만들게 되기까지의 과정이다. This post shows a method to build a personal website or blog using Jekyll hosted by Github pages"
toc: true
toc_label: "개인 블로그 만들기"
toc_sticky: true
published: true
---
...
5. 들어갈때마다 고수들 포스팅 보고 기 안 죽어도 됨

그때는 몰랐다. 이게 이렇게 까지 알아야 할 것도 해야 할 것도 많을 줄은...
...
1. Jekyll 설치 전, Ruby 설치
    ...
    > 잘 모르지만 rbenv가 ruby 가상환경을 관리해주는 툴인듯 싶다. 특히 맥은 권한 문제 때문에 그냥 글로벌에 바로 ruby를 설치해서 하려니까 잘 안되더라.  
    > `rbenv install (version)` 을 사용하자.
    {:  .notice--info}
